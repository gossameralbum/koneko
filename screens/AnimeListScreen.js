...
const AnimeListScreen = () => {
  ...
  const renderTabs = () => {
    const tabs = ['Watching', 'Completed', 'Planning', 'Paused', 'Dropped'];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.tabContent}>
        <Text style={styles.centerText}>Nothing to see here yet! Add animes to your {['Watching', 'Completed', 'Planning', 'Paused', 'Dropped'][tabIndex]} list.</Text>
      </View>
    </View>
  );
};
